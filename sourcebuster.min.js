    ...
    return function e(t, r, n) {
            ...
            t.exports = {
                ...
                set: function(e, t, r, n, a) {
                    ...
                    if (r) {
                        ...
                        i = '';
                    s = n && !a ? ';domain=.' + n : '';
                    let c = this.encodeData(t);
                    this.useBase64 && (c = btoa(c).replace(/=+$/, '')),
                    document.cookie = this.encodeData(e) + '=' + c + i + s + '; path=/';
                },
                get: function(e) {
                    for (let t = this.encodeData(e) + '=', r = document.cookie.split(';'), n = 0; n < r.length; n++) {
                        for (var a = r[n]; ' ' === a.charAt(0); )
                            a = a.substring(1, a.length);
                        if (0 === a.indexOf(t)) {
                            let i = a.substring(t.length, a.length);
                            if (/^[A-Za-z0-9+/]+$/.test(i))
                                try {
        ...
        5: [function(e, t, r) {
            ...
            t.exports = {
                ...
                setDate: function(e, t) {
                    const r = e.getTimezoneOffset() / 60
                      , n = e.getHours()
                      , a = t || 0 === t ? t : -r;
        ...
        6: [function(e, t, r) {
            ...
            t.exports = function(e) {
                let t, r, p, f, m, d, l, g, h, y, _, v, b, x = c.fetch(e), k = s.getParam(), w = x.domain.host, q = x.domain.isolate, I = x.lifetime;
                function j(e) {
                    switch (e) {
                    case a.traffic.utm:
                        t = a.traffic.utm,
                ...
                function R(e) {
                    ...
                    case a.traffic.organic:
                        return !!t && H(t) && function(e) {
                            const t = new RegExp('^(?:.*\\.)?' + o.escapeRegexp('yandex') + '\\..{2,9}$')
                            ...
                            if (!s.parse(e).query)
                                return !1;
                            for (let i = 0; i < x.organics.length; i++) {
                    ...
                    case a.traffic.referral:
                        return !!t && H(t) && function(e) {
                            if (!(x.referrals.length > 0))
                                ...
                                !0;
                            for (let t = 0; t < x.referrals.length; t++) {
                ...
                function H(e) {
                    if (x.domain) {
                        ...
                        const t = new RegExp('^(?:.*\\.)?' + o.escapeRegexp(w) + '$','i');
