...
!function(t, e) {
    ...
    const je = {
        ...
        phase: 'main',
        fn: function(t) {
            let e, i = t.state, n = t.name, s = t.options, o = i.elements.arrow, r = i.modifiersData.popperOffsets, a = be(i.placement), l = Ie(a), c = [Vt, qt].indexOf(a) >= 0 ? 'height' : 'width';
            if (o && r) {
    ...
    function We(t) {
        let e, i = t.popper, n = t.popperRect, s = t.placement, o = t.variation, r = t.offsets, a = t.position, l = t.gpuAcceleration, c = t.adaptive, h = t.roundOffsets, d = t.isFixed, u = r.x, f = void 0 === u ? 0 : u, p = r.y, m = void 0 === p ? 0 : p, g = 'function' == typeof h ? h({
            x: f,
            y: m
        }) : {
            x: f,
    ...
    function ti(t, e, i) {
        return e === Gt ? Ze(function(t, e) {
            ...
            let e, i = Le(t), n = Xe(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = ve(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = ve(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + Ye(t), l = -n.scrollTop;
    ...
    function ei(t) {
        let e, i = t.reference, n = t.element, s = t.placement, o = s ? be(s) : null, r = s ? Fe(s) : null, a = i.x + i.width / 2 - n.width / 2, l = i.y + i.height / 2 - n.height / 2;
        switch (o) {
        case zt:
            e = {
                x: a,
    ...
    const ai = {
      ...
      , hi = {
        ...
        fn: function(t) {
            ...
            if (A) {
                if (o) {
                    let L, S = 'y' === y ? zt : Vt, D = 'y' === y ? Rt : qt, $ = 'y' === y ? 'height' : 'width', I = A[y], N = I + g[S], P = I - g[D], M = f ? -T[$] / 2 : 0, j = b === Xt ? E[$] : T[$], F = b === Xt ? -T[$] : -E[$], H = e.elements.arrow, W = f && H ? Ce(H) : {
                        width: 0,
                        height: 0
                ...
                if (a) {
                    let J, Z = 'x' === y ? zt : Vt, tt = 'x' === y ? Rt : qt, et = A[w], it = 'y' === w ? 'height' : 'width', nt = et + g[Z], st = et - g[tt], ot = -1 !== [zt, Vt].indexOf(_), rt = null != (J = null == x ? void 0 : x[w]) ? J : 0, at = ot ? nt : et - E[it] - T[it] - rt + O.altAxis, lt = ot ? et + E[it] + T[it] - rt - O.altAxis : st, ct = f && ot ? function(t, e, i) {
                        const n = Ne(t, e, i);
                        return n > i ? i : n;
    ...
    function di(t, e, i) {
        void 0 === i && (i = !1);
        let n, s, o = me(e), r = me(e) && function(t) {
