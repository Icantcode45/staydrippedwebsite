function focus_populate_live_region() {
    const e = ['woocommerce-message', 'woocommerce-error', 'wc-block-components-notice-banner'].map(function(e) {
        return '.' + e + '[role="alert"]';
    }).join(', ')
...
function refresh_sorted_by_live_region() {
    const e = document.querySelector('.woocommerce-result-count[data-is-sorted-by="true"]');
    if (e)
        var o = e.innerHTML
...
jQuery(function(e) {
    ...
    e('input.qty:not(.product-quantity input.qty)').each(function() {
        const o = parseFloat(e(this).attr('min'));
        o >= 0 && parseFloat(e(this).val()) < o && e(this).val(o);
    });
    const o = 'store_notice' + (e('.woocommerce-store-notice').data('noticeId') || '');
