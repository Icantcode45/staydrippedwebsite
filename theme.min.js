...
function($) {
    ...
    class i {
        ...
        _getTranslateVal(t) {
            const e = Math.sqrt(Math.pow(this.moveVector.x, 2) + Math.pow(this.moveVector.y, 2))
...
function($) {
    ...
    class i {
        ...
        _animateDraggedHandle(t, e) {
            let i = this.$element.offset().left, s = i, n = i + this.containerWidth, o, a = t.originalEvent.pageX + e - this.dragWidth / 2;
            a < s ? a = s : a > n && (a = n);
            const l = 100 * (a - i) / this.containerWidth + '%';
            ...
            return (new google.maps.Geocoder).geocode({
                ...
                if (i == google.maps.GeocoderStatus.OK) {
                    ...
                    null == this.options.markers)
                        ...
                        for (let s = 0; s < this.options.markers.length; s++)
...
function($) {
    ...
    class i {
        ...
        reveal(t) {
            ...
            const r = i.coverArea || e.coverArea;
...
function($) {
    ...
    class o {
        ...
        moveSectionUp() {
            let t = this.getActiveSection().$element.prevAll('.pp-section').filter(':not(:hidden)').first();
            !t.length && this.options.loopTop && (t = this.$sectionElements.last()),
            t.length && this.scrollPage(t);
        }
        moveSectionDown() {
            let t = this.getActiveSection().$element.nextAll('.pp-section').filter(':not(:hidden)').first();
            ...
            if (!i.activeSection.is(t)) {
                ...
                'down' === i.yMovement) {
                    if (i.destination.is('.pp-auto-height')) {
                        const s = -1 * i.destination.outerHeight() + 'px';
        ...
        hashChangeHandler() {
            let t, e = window.location.hash.replace('#', '').split('/')[0];
        ...
        mouseWheelHandler(t) {
            ...
            const s = i.wheelDelta || -i.deltaY || -i.detail
            ...
            const l = e - this.prevTime;
            if (this.prevTime = e,
            l > 200 && (this.scrollings = []),
            !this.isMoving()) {
                let r = this.getActiveSection().$element, d = this.isScrollable(r), h, c, u;
        ...
        touchMoveHandler(t) {
            const e = t.originalEvent;
            if (this.isReallyTouch(e)) {
                const i = this.getActiveSection().$element
                  , s = this.isScrollable(i);
                if (s.length || t.preventDefault(),
                !this.isMoving()) {
                    const n = this.getEventsPage(e);
                    this.touchEndY = n.y,
...
function($) {
    ...
    class s extends i {
        ...
        onMouseLeave(t) {}
        onMouseMove(t) {
            const e = gsap.utils.mapRange(-1, 1, -this.viewSize.width / 4, this.viewSize.width / 4, this.mouse.x)
        ...
        onPositionUpdate() {
            const t = this.plane.position.clone().sub(this.position).multiplyScalar(-this.options.strength);
        ...
        onTargetChange(t) {
            ...
            !this.currentItem.texture)
                return;
            const e = this.currentItem.img.naturalWidth / this.currentItem.img.naturalHeight;
        ...
        onScroll() {
            ...
            const i = () => {
                ...
                this.targetsRects.forEach((i => {
                    if (!i)
                        return;
                    const s = [i.y, this.getVisibilityPercent(i, t)];
                    0 !== s[1] && e.push(s);
                }
                )),
                0 === e.length ? (e[0] = [0, 0],
                ...
                if (isNaN(s)) {
                    ...
                    e.forEach((e => {
                        this.targetsRects.forEach((s => {
                            if (s && s.y === e[0]) {
                                const e = [s.y, this.getVisibilityDistanceFromCenter(s, t)];
